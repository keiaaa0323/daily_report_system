...
<label for="${AttributeConst.REP_NEGOTIATION.getValue()}">商談状況</label><br />
<textarea  name="${AttributeConst.REP_NEGOTIATION.getValue()}" id="${AttributeConst.REP_NEGOTIATION.getValue()}" rows="10" cols="50">${report.negotiation}</textarea>
<br /><br />
